...
hover:shadow-[0_0_40px_rgba(249,115,22,0.3)] inter-var"
      ...
      <div
        onClick={() => router.push(`/cars/${encodeURIComponent(name)}`)}
        ...
        >
          ...
          <div className="relative h-[220px] bg-[#F8FAFC] overflow-hidden">
            ...
            {tag && (
              ...
              bg-[#0466c8] text-white text-[0.68rem]
          ...
          <div className="p-5">
            ...
            bg-[#0466c8] text-white font-bold
            hover:bg-[#1ebe5b] active:bg-[#0466c8] transition-colors"
            >
              Book on WhatsApp
            </CardItem>
          </div>
